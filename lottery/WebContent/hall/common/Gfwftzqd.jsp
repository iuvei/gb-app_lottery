...
<div class="Detailedlist Single wid1">
    ...
    <div class="layout at">
        ...
        <div class="boxt at reboxt">
            ...
            <div class="right">
                <ul>
                    <li><a class="suiji1" id="suiji1" href="javascript:void(0)" onclick="page.PlayWay.getSuiji(1)">随机一注</a></li>
                    <li><a class="suiji5" id="suiji5" href="javascript:void(0)" onclick="page.PlayWay.getSuiji(5)">随机五注</a></li>
                ...
                <a href="javascript:void(0)" id="qrtz" class="ok" onclick="page.PlayWay.buyBtn()"><img src="${resRoot}/themes/default/img/ico54.png" alt="">确认投注</a>
            </div>
        </div>
    </div>
</div>
