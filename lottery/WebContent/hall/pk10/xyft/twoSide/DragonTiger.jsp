...
<tr>
    ...
    <c:set var="odd" value="${lottery.odd}"/>
    <td data-num="${playGroupName}-${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
    <td data-num="${playGroupName}-${lottery.betNum}"><input type="text" class="table-txt" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pk10DragonTiger}" data-bet-num="龙" data-name="${playGroupName}-龙"/></td>

    <c:set var="lottery" value="${odds['虎']}"/>
    <c:set var="odd" value="${lottery.odd}"/>
    <td data-num="${playGroupName}-${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
    <td data-num="${playGroupName}-${lottery.betNum}"><input type="text" class="table-txt" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pk10DragonTiger}" data-bet-num="虎" data-name="${playGroupName}-虎"/></td>
</tr>