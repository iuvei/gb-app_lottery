...
<table class="touzhuArea touzhuArea_pm">
    ...
    <tr>
        ...
        <td data-num="${playGroupName}-${lottery.betNum}" class="pl pl-color" style="cursor: pointer;">${odd}</td>
        <td data-num="${playGroupName}-${lottery.betNum}">
            <input class="amount-input" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pk10DragonTiger}" data-bet-num="龙" data-name="${playGroupName}-龙" type="text"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td data-num="${playGroupName}-${lottery.betNum}" class="pl pl-color" style="cursor: pointer;">${odd}</td>
        <td data-num="${playGroupName}-${lottery.betNum}">
            <input class="amount-input" data-odds="${odd}" data-bet-code="${lottery.betCode}"  data-play="${pk10DragonTiger}" data-bet-num="虎" data-name="${playGroupName}-虎" type="text"/>
        </td>
    </tr>
    </tbody>
