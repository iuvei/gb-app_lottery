...
<tr>
    ...
    <td data-num="${playGroupName}-${lottery.betNum}" class="pl pl-color" data-plid="10168" style="cursor: pointer;">${odd}</td>
    <td data-num="${playGroupName}-${lottery.betNum}"><input class="amount-input"
...
<tr>
    ...
    <td data-num="${playGroupName}-${lottery.betNum}" class="pl pl-color" data-plid="10169" style="cursor: pointer;">${odd}</td>
    <td data-num="${playGroupName}-${lottery.betNum}"><input class="amount-input"
