...
<c:forEach var="i" begin="1" end="10">
    ...
    <tr>
        ...
        <td class="pl pl-color" data-plid="982${i}" style="cursor: pointer;">${odd}</td>
        <td>
...
<tr>
    ...
    <td class="pl pl-color" data-plid="10164" style="cursor: pointer;">${odd}</td>
...
<tr>
    ...
    <td class="pl pl-color" data-plid="10165" style="cursor: pointer;">${odd}</td>
    <td><input class="amount-input"
...
<tr>
    ...
    <td class="pl pl-color" data-plid="10166" style="cursor: pointer;">${odd}</td>
    <td><input class="amount-input"
...
<tr>
    ...
    <td class="pl pl-color" data-plid="10167" style="cursor: pointer;">${odd}</td>
    <td><input class="amount-input"
...
<c:set var="odd" value="${lottery.odd}"/>
<tr>
    <td style="cursor: pointer;"><span class="">龙</span></td>
    <td class="pl pl-color" data-plid="10168" style="cursor: pointer;">${odd}</td>
    <td><input class="amount-input"
               data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pk10DragonTiger}" data-bet-num="龙" data-name="${playGroupName}-龙"
...
<c:set var="odd" value="${lottery.odd}"/>
<tr>
    <td style="cursor: pointer;"><span class="">虎</span></td>
    <td class="pl pl-color" data-plid="10169" style="cursor: pointer;">${odd}</td>
    <td><input class="amount-input"
               data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pk10DragonTiger}" data-bet-num="虎" data-name="${playGroupName}-虎"
