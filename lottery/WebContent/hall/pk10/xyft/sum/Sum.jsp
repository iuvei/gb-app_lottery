            ...
            <td class="td_style">
                <table class="touzhuArea touzhuArea_gyjh_content">
                    ...
                    <tr>
                        ...
                        <td data-num="${lottery.betNum}" class="pl pl-color" data-plid ="10002" style="cursor: pointer;">${odd}</td>
                    ...
                    <tr>
                        ...
                        <td data-num="${lottery.betNum}" class="pl pl-color" data-plid ="10006" style="cursor: pointer;">${odd}</td>
                         <td data-num="${lottery.betNum}" ><input class="amount-input" 
                                   data-odds="${odd}" data-bet-code="${lottery.betCode}"
                    ...
                    <tr>
                        ...
                        <td data-num="${lottery.betNum}" class="pl pl-color" data-plid ="10010" style="cursor: pointer;">${odd}</td>
                         <td data-num="${lottery.betNum}" ><input class="amount-input" 
                                   data-odds="${odd}" data-bet-code="${lottery.betCode}"
