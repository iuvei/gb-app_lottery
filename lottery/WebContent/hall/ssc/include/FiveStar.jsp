...
<div class="group">
    <ul>
        <li >
            <b style="width: 83px">五星直选</b>
            <p class="btn_fu_zhi">
                <span class="playPlIdBtn acti" data-pljs="200000" data-play_Code="ssc_wuxing_zhixuan" data-play_id="ssc_wuxing_zhixuan_fs" data-play_pl_id="复式" data-name="5xzxfs" data-fun_zhushu="zhushu_5xzxfs" data-fun_content="content_5xzxfs" data-fun_suiji="suiji_5xzxfs"><a href="javascript:void(0)">直选复式</a></span>
                <span class="playPlIdBtn" data-pljs="200000" data-play_Code="ssc_wuxing_zhixuan" data-play_id="ssc_wuxing_zhixuan_ds" data-play_pl_id="单式" data-name="5xzxds" data-fun_zhushu="zhushu_5xzxds" data-fun_content="content_5xzxds" data-fun_suiji="suiji_5xzxds"><a href="javascript:void(0)">直选单式</a></span>
            </p>
        </li>
    </ul>
</div>
...
<script type="text/javascript">
    curl(['site/hall/ssc/FiveStar'], function(PlayWay) {
