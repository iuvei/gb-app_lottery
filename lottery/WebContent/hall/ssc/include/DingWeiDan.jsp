...
<input class="playPlIdBtn acti" data-pljs="20"  data-play_Code="ssc_yixing"  data-play_id="ssc_yixing_dwd" data-play_pl_id="定位胆" data-name="dwd" data-fun_zhushu="zhushu_dwd" data-fun_content="content_dwd" data-fun_suiji="suiji_dwd" type="hidden" />
...
<script type="text/javascript">
    curl(['site/hall/ssc/DingWeiDan'], function(PlayWay) {
