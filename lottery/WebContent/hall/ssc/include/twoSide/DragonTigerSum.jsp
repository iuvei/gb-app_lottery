...
<table width="100%" border="1">
    ...
    <tr>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="总和、龙虎和-${lottery.betNum}" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${dragonTigerTie}" data-bet-num="${lottery.betNum}"></td>

        <c:set var="lottery" value="${fiveSumOdd['总大']}"/>
        <c:set var="odd" value="${lottery.odd}"/>
        <td data-num="${lottery.betNum}" class="pointer"><strong>总大</strong></td>
        <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="总和、龙虎和-${lottery.betNum}" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${fiveSumBigSmall}" data-bet-num="${lottery.betNum}"></td>

        <c:set var="lottery" value="${fiveSumOdd['总单']}"/>
        <c:set var="odd" value="${lottery.odd}"/>
        <td data-num="${lottery.betNum}" class="pointer"><strong>总单</strong></td>
        <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="总和、龙虎和-${lottery.betNum}" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${fiveSumSingleDouble}" data-bet-num="${lottery.betNum}"></td>
    </tr>
