...
<div class="help_list">
    ...
    <div class="help_col show">
        ...
        <h5><strong>【冠亚军和】</strong></h5>
        <p><strong>◎冠亚军和>>冠亚军和</strong><br>
        <p>冠军号码与亚军号码的和值区间为3~19，当投注组合符合冠亚军和值，即视为中奖。</p>
        <p><strong>◎冠亚军和>>冠亚军和大小</strong><br>
        <p>当开奖结果冠军号码与亚军号码的和值大于11为大，投注“和大”则视为中奖；小于11为小，投注“和小”则视为中奖；等于11视为和(不计算输赢)。</p>
        <p><strong>◎冠亚军和>>冠亚军和单双</strong><br>
        <p>当开奖结果冠军号码与亚军号码的和值为单数如9、13，投注“和单”则视为中奖；为双数如12、16，投注“和双”则视为中奖；若总和为11，则视为和(不计算输赢)。</p>
        <p><strong>◎冠亚军和>>冠亚军和指定</strong><br>
        <p>“冠亚和值”可能出现的结果为3～19， 投中对应“冠亚和值”数字的视为中奖，其余视为不中奖。</p>
