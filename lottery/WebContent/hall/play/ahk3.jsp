...
<div class="help_list">
    ...
    <div class="help_col show">
        ...
        <h5><strong>【三同号通选】</strong></h5>
        <p>对111,222,333,444,555,666进行投注。<br>
            举例：开奖号码中出现：3个2或3个其他数字，即中三同号一等奖。</p>
        <h5><strong>【三同号单选】</strong></h5>
        <p>选择任意一组以上三位相同的号码。<br>
            举例：222；开奖号码中出现：3个2 (顺序不限)，即中三同号一等奖。</p>
        <h5><strong>【二同号复选】</strong></h5>
        <p>是指对三个号码中两个指定的相同号码。<br>
            举例：11；开奖号码为：112，211，121，即中奖。</p>
        <h5><strong>【二同号单选】</strong></h5>
        <p>是指对三个号码中两个指定的相同号码和一个指定的不同号码进行投注。<br>
            举例：112；开奖号码112，121，211，即中奖。</p>
        <h5><strong>【三不同号】</strong></h5>
        <p>从1-6中任意选择3个或3个以上号码。<br>
            举例：2,5,6；开奖号码中出现：1个2、1个5、1个6 (顺序不限)，即中三不同号一等奖。</p>
        <h5><strong>【二不同号】</strong></h5>
        <p>从 1-6 中任意选择2个或2个以上号码。<br>
            举例：2,5；开奖号码中出现：1个2、1个5 (顺序不限)，即中二不同号一等奖。</p>
        <h5><strong>【三连号通选】</strong></h5>
        <p>对三个相连的号码进行投注(123,234,345,456)四个号码。<br>
            举例：开奖号码前三位：123,234,345,456，即中前三直选一等奖。</p>
    </div>
    <div class="help_col">
        <h5><strong>总则</strong></h5>
        <p>1.	根据《彩票管理条例》等有关规定，制定本规则。<br/>
            2.	中国福利彩票安徽省快三游戏（以下简称“快三”）由中国福利彩票发行管理中心和组织销售，安徽省福利彩票销售机构（以下称“安徽福彩机构”）在所辖区域内承销。<br/>
            3.	快三采用计算机网络系统发行，在安徽福彩机构设置的销售网点销售，定期开奖。<br/>
            4.	快三实行自愿购买，凡购买该彩票均被视为同意并遵守本规则。<br/>
            5.	不得向未成年人出售彩票或兑付奖金。<br/>
