        ...
        <div class="table-common clearfix">
            <table width="100%" border="1">
                ...
                <c:forEach var="i" begin="1" end="6">
                    ...
                    <td data-num="三军-${i}" style="cursor: pointer;"><em class="gr gr-dice-${i} fs1"></em></td>
                    <td data-num="三军-${i}" style="cursor: pointer;"><strong class="color-red pl">${odd}</strong></td>
                    <td data-num="三军-${i}"><input type="text" class="table-txt" data-bet-code="${lottery.betCode}" data-play="${armedForces}" data-bet-num="${lottery.betNum}" data-odds="${odd}" data-name="三军-${i}"/></td>
                    <c:if test="${i%3==0}">
                        </tr>
                    </c:if>
                </c:forEach>
