...
<c:if test="${fn:length(odds) > 0}">
    ...
    <table width="100%" border="1" class="num">
        ...
        <tr>
            ...
            <td data-num="${lottery.betNum}" class="pointer"><strong>0</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾0" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾0"/></td>

            <c:set var="lottery" value="${odds['尾1']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>1</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾1" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾1"/></td>

            <c:set var="lottery" value="${odds['尾2']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>2</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾2" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾2"/></td>

            <c:set var="lottery" value="${odds['尾3']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>3</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾3" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾3"/></td>

            <c:set var="lottery" value="${odds['尾4']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>4</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾4" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾4"/></td>
        </tr>
        <tr>
            ...
            <td data-num="${lottery.betNum}" class="pointer"><strong>5</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾5" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾5"/></td>

            <c:set var="lottery" value="${odds['尾6']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>6</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾6" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾6"/></td>

            <c:set var="lottery" value="${odds['尾7']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>7</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾7" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾7"/></td>

            <c:set var="lottery" value="${odds['尾8']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>8</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾8" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾8"/></td>

            <c:set var="lottery" value="${odds['尾9']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong>9</strong></td>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}尾数-尾9" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3Mantissa}" data-bet-num="尾9"/></td>
    ...
    <table width="100%" border="1" class="num">
        ...
        <tr>
            ...
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}-大" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3MantissaBigSmall}" data-bet-num="大"/></td>

            <c:set var="lottery" value="${odds['小']}"/>
            <c:set var="odd" value="${lottery.odd}"/>
            <td data-num="${lottery.betNum}" class="pointer"><strong class="color-red pl">${odd}</strong></td>
            <td data-num="${lottery.betNum}"><input type="text" class="table-txt" data-name="${title}-小" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3Sum3MantissaBigSmall}" data-bet-num="小"/></td>
