...
<table width="100%" border="1" class="num">
    ...
    <tr>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num0" data-name="跨度-0" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="0"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num1" data-name="跨度-1" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="1"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num2" data-name="跨度-2" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="2"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num3" data-name="跨度-3" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="3"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num4" data-name="跨度-4" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="4"/></td>
    </tr>
    <tr>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num5" data-name="跨度-5" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="5"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num6" data-name="跨度-6" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="6"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num7" data-name="跨度-7" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="7"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num8" data-name="跨度-8" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="8"/></td>
        ...
        <td data-num="${lottery.betNum}"><input type="text" class="table-txt num9" data-name="跨度-9" data-odds="${odd}" data-bet-code="${lottery.betCode}" data-play="${pl3OneDigital}" data-bet-num="9"/></td>
